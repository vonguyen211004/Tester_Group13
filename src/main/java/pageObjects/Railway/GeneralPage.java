...
public class GeneralPage {
    ...
    public GeneralPage(WebDriver driver) {
        this.driver = driver;  // Initialize WebDriver in the constructor
    }
    ...
    public LoginPage gotoLoginPage() {
        ...
        return new LoginPage(driver);  // Ensure 'driver' is passed here
    }
    ...
    public MyTicket goToMyTicket() {
        ...
        return  new MyTicket(driver);
    }
    public TimeTablePage goToTimeTablePage() {
        this.getTabTimeTable().click();
        return new TimeTablePage(Constant.WEBDRIVER);
    }
